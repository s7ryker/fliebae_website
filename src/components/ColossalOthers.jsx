      ...
      <motion.div 
        ...
        <div className="flex flex-col">
          ...
          <a href="https://play.google.com/store/apps/details?id=com.AzeTech.fliebae">
            <div className="w-full md:w-fit bg-red-600 rounded-3xl py-2 flex justify-center items-center mt-3 md:mx-5 hover:border-2 hover:border-slate-200 hover:bg-primary transition-opacity duration-200">
