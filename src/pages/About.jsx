...
const About = () => {
  return (
    <div className="container my-16">
      <h1 className="text-text1 font-bold text-2xl ml-20 mb-5">Our Story</h1>
      <div className="flex flex-row justify-evenly">
        <div className="flex flex-col justify-start">
          <p className="text-gray-500 font-normal text-sm mx-20 my-3">
        ...
        <img src={about} alt="" className="max-w-md max-h-96" />
      </div>
    </div>
  );
};
